        ...
        <AnimatePresence>
          {selectedId && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <div className="bg-primary ps-9 py-10 rounded-lg max-w-6xl w-full h-[90vh] relative overflow-hidden">
                {/* Ícone de fechar */}
                <button
                ...
                <ScrollArea className="h-full border-collapse overflow-y-auto pr-4"> {/* Padding right para afastar o conteúdo da borda */}
